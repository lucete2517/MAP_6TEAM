    ...
    inner class Holder(view : View) : RecyclerView.ViewHolder(view){
        ...
        fun bind(dateClass : DateClass, position : Int){
            ...
            if(date==0)
                ...
                when(position%7){
                    6 -> OneDay_Date.setTextColor(ContextCompat.getColor(context,R.color.blue))
                    0 -> OneDay_Date.setTextColor(ContextCompat.getColor(context,R.color.red))
                    else -> OneDay_Date.setTextColor(ContextCompat.getColor(context,R.color.black))
                }
