...
class MainActivity : AppCompatActivity() {
    companion object {
        ...
        //저장 관련
        //-----------------------------------------------------------------------------------------------------------------------
        val CategoryList : ArrayList<String> = arrayListOf("식사", "교통", "기타") //카테고리 배열 (스피너를 위해)
        val PaymentList : ArrayList<String> = arrayListOf("현금", "카드") //결제 방법 이름 배열 (스피너를 위해)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val RecordButton = findViewById<FloatingActionButton>(R.id.RecordButton) //오른쪽 아래 버튼
